                                                ...
                                                <div className="col-lg-4">
                                                    <div className="text-center">
                                                        <div style={{marginTop: 20}}>
                                                            <img alt="image" className="img-circle img-lg" src="img/profile_big.jpg"/><br/>
                                                            <button type="submit" className="btn btn-link" >edit photo</button><br/><br/>
                                                        </div>
                                                    </div>
                                                    <div className="row">
                                                        <div className="form-group col-md-12">
                                                            <input id="firstname" name="firstname" type="text" className="form-control required" placeholder="First Name" />
                                                        </div>
                                                        <div className="form-group col-md-12">
                                                            <input id="lastname" name="lastname" type="text" className="form-control required" placeholder="Last Name" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-lg-8">
                                                    <div className="row">
                                                        <div className="form-group col-md-6">
                                                            <br/><input id="email" name="email" type="text" className="form-control" placeholder="Email" disabled="" />
                                                        </div>
                                                        <div className="form-group col-md-6">
                                                            <br/><input id="phone" name="phone" type="text" className="form-control required" placeholder="Phone Number" />
                                                        </div>
                                                    </div>
                                                    <div className="row">
                                                        ...
                                                        <div className="form-group col-md-12">
                                                            <input id="street2" name="street2" type="text" className="form-control" placeholder="Apt/Suite #" />
                                                        </div>
                                                        <div className="form-group col-md-3">
                                                            <input id="city" name="city" type="text" className="form-control required" placeholder="City"/>
                                                        </div>
                                                        <div className="form-group col-md-3">
                                                            <select id="state" name="state" data-placeholder="State" className="form-control required select2_demo_3 ">
                                                        ...
                                                        <div className="form-group col-md-3">
                                                            <input id="zip" name="zip" type="text" className="form-control required" placeholder="Zip" />
                                                        </div>
                                                        <div className="form-group col-md-3">
                                                            <select id="country" name="country" data-placeholder="Country" className="form-control required select2_demo_3">
